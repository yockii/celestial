...
<template>
  <n-grid :cols="1" y-gap="16">
    <n-gi>
      <n-space justify="space-between">
        <span></span>
        <n-button type="primary" @click="newInstance" v-if="projectStore.hasResourceCode('project:detail:issue:add')">新建缺陷</n-button>
      </n-space>
    </n-gi>
    <n-gi>
      <n-data-table
  ...
  <n-drawer v-model:show="drawerActive" :default-height="600" resizable placement="bottom">
    <n-drawer-content>
      ...
      <issue-form ref="issueFormRef" v-model:value="instance" />
    </n-drawer-content>
  </n-drawer>
