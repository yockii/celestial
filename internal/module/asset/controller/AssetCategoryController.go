...
func (c *assetCategoryController) Add(ctx *fiber.Ctx) error {
	instance := new(model.AssetCategory)
	...
	duplicated, success, err := service.AssetCategoryService.Add(instance)
	if err != nil {
		return ctx.JSON(&server.CommonResponse{
...
func (c *assetCategoryController) Update(ctx *fiber.Ctx) error {
	instance := new(model.AssetCategory)
	if err := ctx.BodyParser(instance); err != nil {
		logger.Errorln(err)
		return ctx.JSON(&server.CommonResponse{
	...
	success, err := service.AssetCategoryService.Update(instance)
	if err != nil {
		return ctx.JSON(&server.CommonResponse{
			Code: server.ResponseCodeDatabase,
			Msg:  server.ResponseMsgDatabase + err.Error(),
...
func (c *assetCategoryController) Delete(ctx *fiber.Ctx) error {
	instance := new(model.AssetCategory)
	...
	success, err := service.AssetCategoryService.Delete(instance.ID)
	if err != nil {
		return ctx.JSON(&server.CommonResponse{
			Code: server.ResponseCodeDatabase,
			Msg:  server.ResponseMsgDatabase + err.Error(),
...
func (c *assetCategoryController) List(ctx *fiber.Ctx) error {
	instance := new(domain.AssetCategoryListRequest)
	if err := ctx.QueryParser(instance); err != nil {
		logger.Errorln(err)
		return ctx.JSON(&server.CommonResponse{
			Code: server.ResponseCodeParamParseError,
...
func (c *assetCategoryController) Instance(ctx *fiber.Ctx) error {
	condition := new(model.AssetCategory)
	...
	dept, err := service.AssetCategoryService.Instance(condition.ID)
	if err != nil {
		return ctx.JSON(&server.CommonResponse{
			Code: server.ResponseCodeDatabase,
			Msg:  server.ResponseMsgDatabase + err.Error(),
