...
func InitRouter() {
	...
	// 项目基础信息
	{
		...
		project.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectController.Instance)
	...
	// 项目成员
	{
		...
		projectMember.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectMemberController.List)
		projectMember.Get("/listByProject", middleware.NeedAuthorization(constant.NeedLogin), ProjectMemberController.ListLiteByProjectId)
	...
	// 项目计划
	{
		...
		projectPlan.Delete("/delete", middleware.NeedAuthorization(constant.NeedLogin), ProjectPlanController.Delete)
		projectPlan.Put("/update", middleware.NeedAuthorization(constant.NeedLogin), ProjectPlanController.Update)
		projectPlan.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectPlanController.List)
		projectPlan.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectPlanController.Instance)
		projectPlan.Get("/executing", middleware.NeedAuthorization(constant.NeedLogin), ProjectPlanController.ExecutingPlanByProject)
	...
	// 项目模块
	{
		...
		projectModule.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectModuleController.List)
	...
	// 项目需求
	{
		...
		projectRequirement.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectRequirementController.List)
		projectRequirement.Get("/listForTask", middleware.NeedAuthorization(constant.NeedLogin), ProjectRequirementController.ListForTask)
		projectRequirement.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectRequirementController.Instance)
		// 3种状态修改
	...
	// 项目变更
	{
		...
		projectChange.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectChangeController.List)
		projectChange.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectChangeController.Instance)
	...
	// 项目缺陷
	{
		...
		projectIssue.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectIssueController.List)
		projectIssue.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectIssueController.Instance)
	...
	// 项目风险
	{
		...
		projectRisk.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectRiskController.List)
		projectRisk.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectRiskController.Instance)
		projectRisk.Get("/coefficient", middleware.NeedAuthorization(constant.NeedLogin), ProjectRiskController.CalculateRiskByProject)
	...
	// 项目资产
	{
		...
		projectAsset.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectAssetController.List)
		projectAsset.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectAssetController.Instance)
