...
func (c *projectTestCaseItemController) Add(ctx *fiber.Ctx) error {
	...
	// 判断权限
	if uid, success, err := helper.CheckResourceCodeInProject(ctx, instance.ProjectID, constant.ResourceProjectTestCaseItemAdd); err != nil {
		return err
	} else if !success {
		return nil
	} else {
...
func (c *projectTestCaseItemController) BatchAdd(ctx *fiber.Ctx) error {
	...
	// 判断权限
	if uid, success, err := helper.CheckResourceCodeInProject(ctx, list[0].ProjectID, constant.ResourceProjectTestCaseItemAdd); err != nil {
		return err
	} else if !success {
		return nil
	} else {
...
func (c *projectTestCaseItemController) Update(ctx *fiber.Ctx) error {
	...
	// 判断权限
	var success bool
	if _, success, err = helper.CheckResourceCodeInProject(ctx, oldInstance.ProjectID, constant.ResourceProjectTestCaseItemUpdate); err != nil {
		return err
	} else if !success {
		return nil
	}
...
func (c *projectTestCaseItemController) UpdateStatus(ctx *fiber.Ctx) error {
	...
	// 判断权限
	var success bool
	if _, success, err = helper.CheckResourceCodeInProject(ctx, oldInstance.ProjectID, constant.ResourceProjectTestCaseItemUpdateStatus); err != nil {
		return err
	} else if !success {
		return nil
	}
...
func (c *projectTestCaseItemController) Delete(ctx *fiber.Ctx) error {
	...
	// 判断权限
	var success bool
	if _, success, err = helper.CheckResourceCodeInProject(ctx, oldInstance.ProjectID, constant.ResourceProjectTestCaseItemDelete); err != nil {
		return err
	} else if !success {
		return nil
	}
...
func (c *projectTestCaseItemController) List(ctx *fiber.Ctx) error {
	...
	if _, success, err := helper.CheckResourceCodeInProject(ctx, instance.ProjectID, constant.ResourceProjectTestCaseItemList); err != nil {
		return err
	} else if !success {
		return nil
	}
...
func (c *projectTestCaseItemController) Instance(ctx *fiber.Ctx) error {
	...
	if _, success, err := helper.CheckResourceCodeInProject(ctx, dept.ProjectID, constant.ResourceProjectTestCaseItemInstance); err != nil {
		return err
	} else if !success {
		return nil
	}
