...
func InitRouter() {
	// 项目测试封版
	{
		...
		projectTest.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestController.List)
		projectTest.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestController.Instance)
	...
	// 项目测试用例
	{
		...
		projectTest.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestCaseController.List)
		projectTest.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestCaseController.Instance)
		projectTest.Get("/listWithItems", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestCaseController.ListWithItems)
	...
	// 项目测试用例项
	{
		...
		projectTestCase.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestCaseItemController.List)
		projectTestCase.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestCaseItemController.Instance)
	...
	// 项目测试用例项步骤
	{
		...
		projectTestCaseStep.Get("/list", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestCaseItemStepController.List)
		projectTestCaseStep.Get("/instance", middleware.NeedAuthorization(constant.NeedLogin), ProjectTestCaseItemStepController.Instance)
